...
class EvalConfig(Config):
    def __init__(self):
        ...
        self.gpu_arch = ["Ampere"]  # 4090 Ada; A6000 Ampere
...
def main(config: EvalConfig):
    ...
    if config.num_samples_per_problem > 1:
        ...
        #     p_values = [0.0, 0.5, 1.0, 1.5, 2]
        #     calculate_fastp_at_k(eval_file_path, baseline_file_path, config.level,
        #                          config.pass_at_k_values, p_values)
